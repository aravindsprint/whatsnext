...
<template>
  <div class="wn-templates">
    ...
    <div class="wn-template-grid">
      <div v-for="t in templates" :key="t.name" class="wn-card wn-template-card" @click="openEdit(t)">
...
.wn-toolbar { display: flex; justify-content: space-between; align-items: center; }
